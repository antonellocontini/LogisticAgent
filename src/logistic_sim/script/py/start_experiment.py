...
def run_experiment(MAP, NROBOTS, INITPOS, ALG_SHORT, LOC_MODE, NAV_MODULE, GWAIT, COMMDELAY, TERM, TIMEOUT, CUSTOM_STAGE, SPEEDUP):
    ...
    cmd = '~/./LogisticAgent_ws/src/patrolling_sim/script/py/setinitposes.py '+MAP+' "'+iposes+'"'
    os.system(cmd)
    print cmd    
    os.system('sleep 1')
    ...
    os.system("~/./LogisticAgent_ws/src/patrolling_sim/script/sh/stop_experiment.sh")
